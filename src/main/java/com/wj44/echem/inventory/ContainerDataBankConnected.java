 ...
 */
public class ContainerDataBankConnected extends ContainerEChem
{
    protected TileEntityDataBank tileEntityDataBank;
    ...
    public ItemStack slotClick(int slotId, int clickedButton, int mode, EntityPlayer playerIn)
    {
        ...
        else
        {
            ...
            else if (mode == 3)
            {
                ...
                else if (slotId >= tileEntity.getSizeInventory() && slotId <= tileEntity.getSizeInventory() + tileEntityDataBank.getSizeInventory() && slotId != 0)
                {
